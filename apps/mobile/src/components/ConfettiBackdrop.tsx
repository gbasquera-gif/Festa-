...
// abertura do app. As peças ficam no terço superior e nas margens laterais,
// longe da faixa central onde a logo e o texto são lidos.
const PIECES: Piece[] = [
...
/**
 * Camada decorativa da tela de boas-vindas: confetes espalhados e os dois
 * quartos de círculo (coral e dourado) que ancoram o rodapé.
 */
