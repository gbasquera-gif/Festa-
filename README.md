...
- **Admin**: `pnpm --filter @festae/admin run build` gera estático em `apps/admin/dist` — publique em qualquer host de site estático (Netlify, Vercel, S3+CloudFront etc), configurando `VITE_API_URL` para a URL pública do backend.
